            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="checkbox-filter">
                                <c:forEach items="${listAllCate}" var="cate">
                                    <div class="input-checkbox">
                                        <a class="${cIDTag == cate.id ? "boiDo":""}" href="categoryControl?cID=${cate.id}">${cate.name}</a>
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <!-- store products -->
                        <c:forEach items="${listAllProd}" var="product" varStatus="loop">
                                ...
                                <div class="col-md-4">
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="${product.imgUrl}" style="height: 300px" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="detail?pID=${product.productID}">${product.name}</a></h3>
